<?php
    ...
    if(!empty($appointments)){
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST' and $_POST['triggers'] == 'update_appointment'){
                         	...
                         	<form action="" method="POST" class="col s12">
								  <div class="row">
									<div class="input-field col s6">
									  ...
									  <input id="icon_prefix" readonly value="<?php echo $appointments->receptionist ?>" type="text" class="validate">
									  <label for="icon_prefix">Receptionist Name</label>
									</div>
									<div class="input-field col s6">
									  <i class="material-icons prefix">account_circle</i>
									  <input id="icon_prefix" readonly value="<?php echo $appointments->patient ?>" type="text" class="validate">
									  <label for="icon_prefix">Patient Name</label>
									</div>
								  </div>
                                <div class="row">
                                    <div class="input-field col s12">
                                    <textarea id="textarea1" name="report" class="materialize-textarea"><?php echo $appointments->report ?></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <input type="date" id="next_app_date" value="<?php echo $appointments->next_app_date ?>" name="next_app_date" class="materialize-input">
                                    </div>
                                </div>
                            <button type="submit" name="triggers" value="update_appointment" class="waves-effect waves-light btn">UPDATE</button>
                            </form>
                        </div>
                        <!--End Advanced Tables -->
                    </div>
